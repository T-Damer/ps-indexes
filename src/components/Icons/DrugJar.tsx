export default function DrugJar() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
      <g fill="none" stroke="currentColor" stroke-width="1.5">
        ...
        <path stroke-linecap="round" d="M2.5 18h8m-8-8h15" opacity="0.5" />
        <path
          stroke-linecap="round"
          d="M10.5 22H6.957c-.571 0-.857 0-1.127-.037a4 4 0 0 1-2.153-1.008c-.201-.184-.384-.404-.75-.842A4 4 0 0 1 2 17.552v-6.63A4 4 0 0 1 3.501 7.8l2.403-1.922c.543-.434.814-.652 1.136-.764C7.36 5 7.708 5 8.403 5h3.24c.7 0 1.051 0 1.375.115c.324.114.597.335 1.141.776l2.358 1.908A4 4 0 0 1 18 10.91v1.59m-8-.5v4m-2-2h4"
        />
